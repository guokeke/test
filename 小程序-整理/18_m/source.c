...
int t1394_IsochCleanup(int a) { int rand_x = rand(); return rand_x; }
int ExAllocatePool(int a, int b) { int rand_x = rand(); return rand_x; }
int t1394Diag_PnpStopDevice(int a, int b) { int rand_x = rand(); return rand_x; }
int t1394_SubmitIrpSynch(int a, int b) { int rand_x = rand(); return rand_x; }
int IoFreeIrp(int a) { int rand_x = rand(); return rand_x; }
int IoSetDeviceInterfaceState() { int rand_x = rand(); return rand_x; }
int RtlZeroMemory(int a, int b) { int rand_x = rand(); return rand_x; }
int KeCancelTimer() { int rand_x = rand(); return rand_x; }
int IoAllocateIrp(int a, int b) { int rand_x = rand(); return rand_x; }
int IoFreeMdl() { int rand_x = rand(); return rand_x; }
int IoSetCancelRoutine(int a) { int rand_x = rand(); return rand_x; }
int ExFreePool0() { int rand_x = rand(); return rand_x; }
int ExFreePool1(int a) { int rand_x = rand(); return rand_x; }
int ExFreePool2(int a, int b) { int rand_x = rand(); return rand_x; }
int IoCompleteRequest(int a) { phi_io_compl = 1; int rand_x = rand(); return rand_x; }///多了wangmeng
