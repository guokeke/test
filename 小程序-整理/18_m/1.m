frame(fp_executionPath,fp_values,lock1,lock2,lock3,lock4,lock5,lock6,CancelIrql,irql,csl,DeviceObject,Irp,ntStatus,deviceExtension,Irql,k1,k2,k3,k4,k5,CromData,AsyncAddressData,IsochResourceData,IsochDetachData,i,pIrb,ResourceIrp,StackSize,BusResetIrp,prevCancel,keA,keR,ioA,ioR,phi_nSUC_ret,phi_io_compl,pc) and (
...
int pc and skip;
 ...
 function t1394_IsochCleanup ( int a,int RValue )
 {
	 ...
	 if(!feof(fp_values))then{
	    fscanf(fp_values, "%d", &t1394_IsochCleanup_rand_x) and skip   
	 }
	 else{
	    t1394_IsochCleanup_rand_x:=rand(RValue)
	 };
  ...
  function ExAllocatePool ( int a,int b,int RValue )
 {
	 ...
	 if(!feof(fp_values))then{
	    fscanf(fp_values, "%d", &ExAllocatePool_rand_x) and skip   
	 }
	 else{
	    ExAllocatePool_rand_x:=rand(RValue)
	 };
  ...
  function t1394Diag_PnpStopDevice ( int a,int b,int RValue )
 {
	 ...
	 if(!feof(fp_values))then{
	    fscanf(fp_values, "%d", &t1394Diag_PnpStopDevice_rand_x) and skip   
	 }
	 else{
	    t1394Diag_PnpStopDevice_rand_x:=rand(RValue)
	 };
  ...
  function t1394_SubmitIrpSynch ( int a,int b,int RValue )
 {
	 ...
	 if(!feof(fp_values))then{
	    fscanf(fp_values, "%d", &t1394_SubmitIrpSynch_rand_x) and skip   
	 }
	 else{
	    t1394_SubmitIrpSynch_rand_x:=rand(RValue)
	 };
  ...
  function IoFreeIrp ( int a,int RValue )
 {
	 ...
	 if(!feof(fp_values))then{
	    fscanf(fp_values, "%d", &IoFreeIrp_rand_x) and skip   
	 }
	 else{
	    IoFreeIrp_rand_x:=rand(RValue)
	 };
  ...
  function IoSetDeviceInterfaceState ( int RValue )
 {
	 ...
	 if(!feof(fp_values))then{
	    fscanf(fp_values, "%d", &IoSetDeviceInterfaceState_rand_x) and skip   
	 }
	 else{
	    IoSetDeviceInterfaceState_rand_x:=rand(RValue)
	 };
  ...
  function RtlZeroMemory ( int a,int b,int RValue )
 {
	 ...
	 if(!feof(fp_values))then{
	    fscanf(fp_values, "%d", &RtlZeroMemory_rand_x) and skip   
	 }
	 else{
	    RtlZeroMemory_rand_x:=rand(RValue)
	 };
  ...
  function KeCancelTimer ( int RValue )
 {
	 ...
	 if(!feof(fp_values))then{
	    fscanf(fp_values, "%d", &KeCancelTimer_rand_x) and skip   
	 }
	 else{
	    KeCancelTimer_rand_x:=rand(RValue)
	 };
  ...
  function IoAllocateIrp ( int a,int b,int RValue )
 {
	 ...
	 if(!feof(fp_values))then{
	    fscanf(fp_values, "%d", &IoAllocateIrp_rand_x) and skip   
	 }
	 else{
	    IoAllocateIrp_rand_x:=rand(RValue)
	 };
  ...
  function IoFreeMdl ( int RValue )
 {
	 ...
	 if(!feof(fp_values))then{
	    fscanf(fp_values, "%d", &IoFreeMdl_rand_x) and skip   
	 }
	 else{
	    IoFreeMdl_rand_x:=rand(RValue)
	 };
  ...
  function IoSetCancelRoutine ( int a,int RValue )
 {
	 ...
	 if(!feof(fp_values))then{
	    fscanf(fp_values, "%d", &IoSetCancelRoutine_rand_x) and skip   
	 }
	 else{
	    IoSetCancelRoutine_rand_x:=rand(RValue)
	 };
  ...
  function ExFreePool0 ( int RValue )
 {
	 ...
	 if(!feof(fp_values))then{
	    fscanf(fp_values, "%d", &ExFreePool0_rand_x) and skip   
	 }
	 else{
	    ExFreePool0_rand_x:=rand(RValue)
	 };
  ...
  function ExFreePool1 ( int a,int RValue )
 {
     ...
     ExFreePool1_rand_x:=rand(RValue);
	  if(!feof(fp_values))then{
	    fscanf(fp_values, "%d", &ExFreePool1_rand_x) and skip   
	 }
	 else{
	    ExFreePool1_rand_x:=rand(RValue)
	 };
  ...
  function ExFreePool2 ( int a,int b,int RValue )
 {
	 ...
	 if(!feof(fp_values))then{
	    fscanf(fp_values, "%d", &ExFreePool2_rand_x) and skip   
	 }
	 else{
	    ExFreePool2_rand_x:=rand(RValue)
	 };
  ...
  function IoCompleteRequest ( int a,int RValue )
 {
     ...
     //IoCompleteRequest_rand_x:=rand(RValue);
	  if(!feof(fp_values))then{
	    fscanf(fp_values, "%d", &IoCompleteRequest_rand_x) and skip   
	 }
	 else{
	    IoCompleteRequest_rand_x:=rand(RValue)
	 };
  ...
  function main ( int RValue )
 {
     ...
     //k1:=rand(RValue);
	  if(!feof(fp_values))then{
	    fscanf(fp_values, "%d", &k1) and skip   
	 }
	 else{
	    k1:=rand(RValue)
	 };
     ...
     while( k1>0)
     {
          fputs("[k1>0]#" ,fp_executionPath ) and skip;
         //CromData:=rand(RValue);
		   if(!feof(fp_values))then{
	             fscanf(fp_values, "%d", &CromData) and skip   
	       }
	       else{
	             CromData:=rand(RValue)
	       };
         ...
         if(CromData!=0) then 
         {
              fputs("[CromData!=0]#",fp_executionPath) and skip;
             int main_2_3_rand_x1 and skip;
             //main_2_3_rand_x1:=rand(RValue);
			  if(!feof(fp_values))then{
	               fscanf(fp_values, "%d", &main_2_3_rand_x1) and skip   
	           }
	           else{
	               main_2_3_rand_x1:=rand(RValue)
	           };
             ...
             //main_2_3_rand_x2:=rand(RValue);
			  if(!feof(fp_values))then{
	               fscanf(fp_values, "%d", &main_2_3_rand_x2) and skip   
	           }
	           else{
	               main_2_3_rand_x2:=rand(RValue)
	           };
     ...
     //k2:=rand(RValue);
	  if(!feof(fp_values))then{
	            fscanf(fp_values, "%d", &k2) and skip   
	   }
	   else{
	            k2:=rand(RValue)
	       };
     ...
     while( k2>0)
     {
          fputs("[k2>0]#" ,fp_executionPath ) and skip;
         //AsyncAddressData:=rand(RValue);
		  if(!feof(fp_values))then{
	            fscanf(fp_values, "%d", &AsyncAddressData) and skip   
	      }
	      else{
	            AsyncAddressData:=rand(RValue)
	       };
         ...
         //main_6_rand_x3:=rand(RValue);
		  if(!feof(fp_values))then{
	            fscanf(fp_values, "%d", &main_6_rand_x3) and skip   
	      }
	      else{
	            main_6_rand_x3:=rand(RValue)
	       };
         ...
         //main_6_rand_x4:=rand(RValue);
		  if(!feof(fp_values))then{
	            fscanf(fp_values, "%d", &main_6_rand_x4) and skip   
	      }
	      else{
	            main_6_rand_x4:=rand(RValue)
	       };
         ...
         //main_6_rand_x5:=rand(RValue);
		   if(!feof(fp_values))then{
	            fscanf(fp_values, "%d", &main_6_rand_x5) and skip   
	      }
	      else{
	            main_6_rand_x5:=rand(RValue)
	       };
         ...
         {
              fputs("[AsyncAddressData!=0]#",fp_executionPath) and skip;
             ExFreePool0(RValue)
         }
         else 
         {
     ...
     while( break$=0 AND   1)
     {
         ...
         k3:=rand(RValue);
		    if(!feof(fp_values))then{
	            fscanf(fp_values, "%d", &k3) and skip   
	      }
	      else{
	            k3:=rand(RValue)
	       };
         ...
         if(k3>0) then 
         {
              fputs("[k3>0]#",fp_executionPath) and skip;
             //IsochDetachData:=rand(RValue);
			   if(!feof(fp_values))then{
	              fscanf(fp_values, "%d", &IsochDetachData) and skip   
	           }
	           else{
	              IsochDetachData:=rand(RValue)
	           };
     ...
     //k4:=rand(RValue);
	  if(!feof(fp_values))then{
	              fscanf(fp_values, "%d", &k4) and skip   
	           }
	           else{
	              k4:=rand(RValue)
	           };
     ...
     while( break$=0 AND   1)
     {
         ...
         if(k4>0) then 
         {
              fputs("[k4>0]#",fp_executionPath) and skip;
             //IsochResourceData:=rand(RValue);
			   if(!feof(fp_values))then{
	              fscanf(fp_values, "%d", &IsochResourceData) and skip   
	           }
	           else{
	              IsochResourceData:=rand(RValue)
	           };
             ...
             {
                  fputs("[IsochResourceData!=0]#",fp_executionPath) and skip;
                 //pIrb:=rand(RValue);
				   if(!feof(fp_values))then{
	              fscanf(fp_values, "%d", &pIrb) and skip   
	           }
	           else{
	              pIrb:=rand(RValue)
	           };
                ...
                // ResourceIrp:=rand(RValue);
				 if(!feof(fp_values))then{
	              fscanf(fp_values, "%d", &ResourceIrp) and skip   
	           }
	           else{
	              ResourceIrp:=rand(RValue)
	           };
			...
			if(!feof(fp_values))then{
	              fscanf(fp_values, "%d", &StackSize) and skip   
	           }
	           else{
	              StackSize:=rand(RValue)
	           };
                 ...
                 {
                      fputs("[ResourceIrp==NULL]#",fp_executionPath) and skip;
                     skip
                 }
                 else
                 {
                     ...
                     if(!pIrb) then 
                     {
                          fputs("[!pIrb]#",fp_executionPath) and skip;
    ...
    // k5:=rand(RValue);
	if(!feof(fp_values))then{
	              fscanf(fp_values, "%d", &k5) and skip   
	           }
	           else{
	              k5:=rand(RValue)
	           };
     ...
     while( k5>0)
     {
          fputs("[k5>0]#" ,fp_executionPath ) and skip;
         prevCancel:=NULL;
         //BusResetIrp:=rand(RValue);
		 if(!feof(fp_values))then{
	              fscanf(fp_values, "%d", &BusResetIrp) and skip   
	           }
	           else{
	              BusResetIrp:=rand(RValue)
	           };
     ...
     if(ntStatus!=2) then 
     {
          fputs("[ntStatus!=2]#",fp_executionPath) and skip;
         phi_nSUC_ret:=1
