//#Unsafe
//
//Formula: (false R (! (oV & ! oW) | (! oZ WU oW)))
//"output Z does never occur after output V until output W"
...
int input, output;
	//@ ltl invariant positive: ([] (! (AP(output == 22) && ! AP(output == 23)) || (! AP(output == 26) WU AP(output == 23))));
