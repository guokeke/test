//#Safe
//
//Formula: (false R (! (oX & ! oU) | (! oU WU (oZ & ! oU))))
//"output Z occurs between output X and output U"
...
int input, output;
	//@ ltl invariant positive: ([] (! (AP(output == 24) && ! AP(output == 21)) || (! AP(output == 21) WU (AP(output == 26) && ! AP(output == 21)))));
