//#Safe
//
//Formula: (false R (! (oU & ! oY) | (! oW WU oY)))
//"output W does never occur after output U until output Y"
...
int input, output;
	//@ ltl invariant positive: ([] (! (AP(output == 21) && ! AP(output == 25)) || (! AP(output == 23) WU AP(output == 25))));
