//#Unsafe
//
//Formula: (false R (! (iD & ! oU) | (! oU U (oW & ! oU))))
//"output W occurs after input D until output U"
...
int input, output;
	//@ ltl invariant positive: ([] (! (AP(input == 4) && ! AP(output == 21)) || (! AP(output == 21) U (AP(output == 23) && ! AP(output == 21)))));
