//#Unsafe
//
//Formula: (false R (! (iE & ! iD) | (! iD U (oZ & ! iD))))
//"output Z occurs after input E until input D"
...
int input, output;
	//@ ltl invariant positive: ([] (! (AP(input == 5) && ! AP(input == 4)) || (! AP(input == 4) U (AP(output == 26) && ! AP(input == 4)))));
