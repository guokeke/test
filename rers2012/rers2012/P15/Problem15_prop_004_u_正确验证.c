//#Unsafe
//
//Formula: (! (true U iF) | (! oV U (iE | iF)))
//"input E precedes output V before input F"
//Formula is not satisfied! An error path is
//[iD, oV, iD, oZ, iD, oV, iF] ([iC, oZ])*
//Problem15.c
//(! (F iF) | (! oV U (iE | iF)));
#include <stdio.h> 
#include <assert.h>
...
int input, output;
	//@ ltl invariant positive: (! (<> AP(input == 6)) || (! AP(output == 22) U (AP(input == 5) || AP(input == 6))));
