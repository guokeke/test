//#Safe
//
//Formula: (false R (! (oX & ! iB) | (! iB U (oU & ! iB))))
//"output U occurs after output X until input B"
...
int input, output;
	//@ ltl invariant positive: ([] (! (AP(output == 24) && ! AP(input == 2)) || (! AP(input == 2) U (AP(output == 21) && ! AP(input == 2)))));
