//#Unsafe
//
//Formula: (false R (! (oU & ! oV) | (! oV WU (oW & ! oV))))
//"output W occurs between output U and output V"
//Formula is not satisfied! An error path is
//[iD, oV, iE, oU, iC, oV] ([iA, iE, oU, iC, oV])*
//Problem15.c
//(G (! (oU & ! oV) | (! oV WU (oW & ! oV))));
#include <stdio.h> 
#include <assert.h>
...
int input, output;
	//@ ltl invariant positive: ([] (! (AP(output == 21) && ! AP(output == 22)) || (! AP(output == 22) WU (AP(output == 23) && ! AP(output == 22)))));
