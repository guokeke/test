//#Safe
//
//Formula: (false R (! (oX & ! oU) | (! oY WU oU)))
//"output Y does never occur after output X until output U"
...
int input, output;
	//@ ltl invariant positive: ([] (! (AP(output == 24) && ! AP(output == 21)) || (! AP(output == 25) WU AP(output == 21))));
