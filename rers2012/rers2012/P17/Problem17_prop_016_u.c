//#Unsafe
//
//Formula: (false R (! (oY & ! oW) | (! oW U (oV & ! oW))))
//"output V occurs after output Y until output W"
//Formula is not satisfied! An error path is
//[iA, oY] ([iC, oZ, iC, oZ, iF])*
//Problem17.c
//(G (! (oY & ! oW) | (! oW U (oV & ! oW))));
#include <stdio.h> 
#include <assert.h>
...
int input, output;
	//@ ltl invariant positive: ([] (! (AP(output == 25) && ! AP(output == 23)) || (! AP(output == 23) U (AP(output == 22) && ! AP(output == 23)))));
