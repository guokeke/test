//#Unsafe
//
//Formula: ((false R ! iE) | (true U (iE & (true U oX))))
//"output X occurs after input E"
//Formula is not satisfied! An error path is
//[iA, oY, iC, oZ, iE] ([oZ, iF, oZ, iE])*
//Problem17.c
//((G ! iE) | (F (iE & (F oX))));
#include <stdio.h> 
#include <assert.h>
...
int input, output;
	//@ ltl invariant positive: (([] ! AP(input == 5)) || (<> (AP(input == 5) && (<> AP(output == 24)))));
