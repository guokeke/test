//#Safe
//
//Formula: (false R (! (oZ & ! oX) | (! oX WU (oU & ! oX))))
//"output U occurs between output Z and output X"
...
int input, output;
	//@ ltl invariant positive: ([] (! (AP(output == 26) && ! AP(output == 24)) || (! AP(output == 24) WU (AP(output == 21) && ! AP(output == 24)))));
