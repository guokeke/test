//#Safe
//
//Formula: (false R (! (oX & ! oY) | (! oY U (oV & ! oY))))
//"output V occurs after output X until output Y"
...
int input, output;
	//@ ltl invariant positive: ([] (! (AP(output == 24) && ! AP(output == 25)) || (! AP(output == 25) U (AP(output == 22) && ! AP(output == 25)))));
