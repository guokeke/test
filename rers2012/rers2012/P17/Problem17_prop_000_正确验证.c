//#Safe
//Formula: (false R (! (iF & ! iB) | (! oV WU iB)))
//"output V does never occur after input F until input B"
...
int input, output;
	//@ ltl invariant positive: ([] (! (AP(input == 6) && ! AP(input == 2)) || (! AP(output == 22) WU AP(input == 2))));
