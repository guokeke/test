//#Safe
//
//Formula: (false R (! (oY & ! oZ) | (! oV WU oZ)))
//"output V does never occur after output Y until output Z"
...
int input, output;
	//@ ltl invariant positive: ([] (! (AP(output == 25) && ! AP(output == 26)) || (! AP(output == 22) WU AP(output == 26))));
