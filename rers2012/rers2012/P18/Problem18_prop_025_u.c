...
int input, output;
	//@ ltl invariant positive: ([] (! (AP(input == 6) && ! AP(output == 26)) || (! AP(output == 26) WU (AP(output == 24) && ! AP(output == 26)))));
