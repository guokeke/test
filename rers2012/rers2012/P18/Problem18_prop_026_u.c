//#Unsafe
//
//Formula: (false R (! (oU & ! oW) | (! oZ WU oW)))
//"output Z does never occur after output U until output W"
//Formula is not satisfied! An error path is
//[iB, oY, iD, oU, iC, oZ] ([iC, oV, iD, oY, iB, oU, iA, oY])*
//Problem18.c
//(G (! (oU & ! oW) | (! oZ WU oW)));
#include <stdio.h> 
#include <assert.h>
...
int input, output;
	//@ ltl invariant positive: ([] (! (AP(output == 21) && ! AP(output == 23)) || (! AP(output == 26) WU AP(output == 23))));
