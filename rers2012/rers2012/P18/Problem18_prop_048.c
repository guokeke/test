//#Safe
//
//Formula: (false R (! (iB & ! oW) | (! oX WU oW)))
//"output X does never occur after input B until output W"
...
int input, output;
	//@ ltl invariant positive: ([] (! (AP(input == 2) && ! AP(output == 23)) || (! AP(output == 24) WU AP(output == 23))));
