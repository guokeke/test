//#Unsafe
//
//Formula: (false R (! (iA & ! oU) | (! oU WU (oV & ! oU))))
//"output V occurs between input A and output U"
//Formula is not satisfied! An error path is
//[iB, oY, iD, oU, iE, oV, iA, oU] ([iD, oZ, iC, oU, iC])*
//Problem18.c
//(G (! (iA & ! oU) | (! oU WU (oV & ! oU))));
#include <stdio.h> 
#include <assert.h>
...
int input, output;
	//@ ltl invariant positive: ([] (! (AP(input == 1) && ! AP(output == 21)) || (! AP(output == 21) WU (AP(output == 22) && ! AP(output == 21)))));
