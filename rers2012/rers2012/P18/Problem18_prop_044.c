//#Safe
//
//Formula: (false R (! ((oX & ! iF) & (true U iF)) | (! oZ U iF)))
//"output Z does never occur between output X and input F"
//Formula is satisfied.
//Problem18.c
//(G (! ((oX & ! iF) & (F iF)) | (! oZ U iF)));
#include <stdio.h> 
#include <assert.h>
#include <math.h>
...
int input, output;
	//@ ltl invariant positive: ([] (! ((AP(output == 24) && ! AP(input == 6)) && (<> AP(input == 6))) || (! AP(output == 26) U AP(input == 6))));
