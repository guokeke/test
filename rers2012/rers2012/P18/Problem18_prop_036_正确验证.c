//#Safe
//
//Formula: (false R (! ((oW & ! oU) & (true U oU)) | (! oX U oU)))
//"output X does never occur between output W and output U"
//Formula is satisfied.
//Problem18.c
//(G (! ((oW & ! oU) & (F oU)) | (! oX U oU)));
#include <stdio.h> 
#include <assert.h>
#include <math.h>
...
int input, output;
	//@ ltl invariant positive: ([] (! ((AP(output == 23) && ! AP(output == 21)) && (<> AP(output == 21))) || (! AP(output == 24) U AP(output == 21))));
