//#Unsafe
//
//Formula: ((false R ! oV) | (true U (oV & (true U oY))))
//"output Y occurs after output V"
//Formula is not satisfied! An error path is
//[iB, oY, iD, oU, iE, oV] ([iA, oU, iA, oV, iA, oU, iA])*
//Problem18.c
//((G ! oV) | (F (oV & (F oY))));
#include <stdio.h> 
#include <assert.h>
...
int input, output;
	//@ ltl invariant positive: (([] ! AP(output == 22)) || (<> (AP(output == 22) && (<> AP(output == 25)))));
