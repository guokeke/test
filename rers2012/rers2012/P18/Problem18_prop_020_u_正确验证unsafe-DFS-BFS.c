//#Unsafe
//
//Formula: (false R (! (iB & ! oU) | (! oU U (oW & ! oU))))
//"output W occurs after input B until output U"
//Formula is not satisfied! An error path is
//[iB, oY] ([iD, oU, iC, oZ, iA, oZ, iB, oY, iC, oU, iA, oY])*
//Problem18.c
//(G (! (iB & ! oU) | (! oU U (oW & ! oU))));
#include <stdio.h> 
#include <assert.h>
...
int input, output;
	//@ ltl invariant positive: ([] (! (AP(input == 2) && ! AP(output == 21)) || (! AP(output == 21) U (AP(output == 23) && ! AP(output == 21)))));
