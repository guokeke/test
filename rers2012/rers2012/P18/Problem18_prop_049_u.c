//#Unsafe
//
//Formula: (false R (! (iC & ! iD) | (! oZ WU iD)))
//"output Z does never occur after input C until input D"
...
int input, output;
	//@ ltl invariant positive: ([] (! (AP(input == 3) && ! AP(input == 4)) || (! AP(output == 26) WU AP(input == 4))));
