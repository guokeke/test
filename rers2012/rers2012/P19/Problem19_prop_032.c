//#Safe
//
//Formula: (false R (! (iB & ! oV) | (! oX WU oV)))
//"output X does never occur after input B until output V"
...
int input, output;
	//@ ltl invariant positive: ([] (! (AP(input == 2) && ! AP(output == 22)) || (! AP(output == 24) WU AP(output == 22))));
