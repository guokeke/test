//#Safe
//
//Formula: (false R (! (oX & ! oV) | (! oV WU (oY & ! oV))))
//"output Y occurs between output X and output V"
...
int input, output;
	//@ ltl invariant positive: ([] (! (AP(output == 24) && ! AP(output == 22)) || (! AP(output == 22) WU (AP(output == 25) && ! AP(output == 22)))));
