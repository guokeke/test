...
//[iF, oW, iA, oY, iB, oU, iD] ([oW, iE, oU, iA, oW, iB, oU, iD])*
//Problem19.c
//(! oU WU (oU WU (! oU WU (oU WU (G ! oU)))));
#include <stdio.h> 
#include <assert.h>
#include <math.h>
...
int input, output;
	//@ ltl invariant positive: (! AP(output == 21) WU (AP(output == 21) WU (! AP(output == 21) WU (AP(output == 21) WU ([] ! AP(output == 21))))));
