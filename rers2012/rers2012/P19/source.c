//#Safe
//Formula: (false R (! (iD & ! iE) | (! oX WU iE)))
//"output X does never occur after input D until input E"
...
int input, output;
	//@ ltl invariant positive: ([] (! (AP(input == 4) && ! AP(input == 5)) || (! AP(output == 24) WU AP(input == 5))));
