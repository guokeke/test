//#Unsafe
//
//Formula: ((false R ! oU) | (true U (oU & (true U oV))))
//"output V occurs after output U"
//Formula is not satisfied! An error path is
//[iF, oW, iA, oY, iB, oU] ([iD, oW, iC, oY, iD, oY, iC])*
//Problem19.c
//((G ! oU) | (F (oU & (F oV))));
#include <stdio.h> 
#include <assert.h>
...
int input, output;
	//@ ltl invariant positive: (([] ! AP(output == 21)) || (<> (AP(output == 21) && (<> AP(output == 22)))));
