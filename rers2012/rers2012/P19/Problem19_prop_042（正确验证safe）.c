//#Safe
//
//Formula: (false R (! ((oX & ! oW) & (true U oW)) | (! oV U oW)))
//"output V does never occur between output X and output W"
//Formula is satisfied.
//Problem19.c
//(G (! ((oX & ! oW) & (F oW)) | (! oV U oW)));
#include <stdio.h> 
#include <assert.h>
#include <math.h>
...
int input, output;
	//@ ltl invariant positive: ([] (! ((AP(output == 24) && ! AP(output == 23)) && (<> AP(output == 23))) || (! AP(output == 22) U AP(output == 23))));
