//#Safe
//
//Formula: (false R (! ((iB & ! oZ) & (true U oZ)) | (! oV U oZ)))
//"output V does never occur between input B and output Z"
//Formula is satisfied.
//Problem19.c
//(G (! ((iB & ! oZ) & (F oZ)) | (! oV U oZ)));
#include <stdio.h> 
#include <assert.h>
#include <math.h>
...
int input, output;
	//@ ltl invariant positive: ([] (! ((AP(input == 2) && ! AP(output == 26)) && (<> AP(output == 26))) || (! AP(output == 22) U AP(output == 26))));
