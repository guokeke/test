//#Safe
//
//Formula: (false R (! (oV & ! iB) | (! iB WU (oW & ! iB))))
//"output W occurs between output V and input B"
...
int input, output;
	//@ ltl invariant positive: ([] (! (AP(output == 22) && ! AP(input == 2)) || (! AP(input == 2) WU (AP(output == 23) && ! AP(input == 2)))));
