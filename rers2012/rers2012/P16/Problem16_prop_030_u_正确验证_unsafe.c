//#Unsafe
//
//Formula: (false R (! (iF & ! iA) | (! oV WU iA)))
//"output V does never occur after input F until input A"
...
int input, output;
	//@ ltl invariant positive: ([] (! (AP(input == 6) && ! AP(input == 1)) || (! AP(output == 22) WU AP(input == 1))));
