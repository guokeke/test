...
//[iA, oV, iE, oU, iB, oZ, iF, oY, iF, oV, iE, oY] ([iF, oV, iE, oY])*
//Problem16.c
//(G (! ((iF & ! oY) & (F oY)) | (! oV U oY)));
#include <stdio.h> 
#include <assert.h>
#include <math.h>
...
int input, output;
	//@ ltl invariant positive: ([] (! ((AP(input == 6) && ! AP(output == 25)) && (<> AP(output == 25))) || (! AP(output == 22) U AP(output == 25))));
