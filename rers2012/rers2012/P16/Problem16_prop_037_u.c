//#Unsafe
//
//Formula: (false R (! (oX & ! oU) | (! oU U (oY & ! oU))))
//"output Y occurs after output X until output U"
//Formula is not satisfied! An error path is
//[iD, oU, iF, oV, iA, oZ, iE, oX] ([iA, oU])*
//Problem16.c
//(G (! (oX & ! oU) | (! oU U (oY & ! oU))));
#include <stdio.h> 
#include <assert.h>
...
int input, output;
	//@ ltl invariant positive: ([] (! (AP(output == 24) && ! AP(output == 21)) || (! AP(output == 21) U (AP(output == 25) && ! AP(output == 21)))));
