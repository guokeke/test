//#Unsafe
//
//Formula: (false R (! (iB & ! oX) | (! oX WU (oW & ! oX))))
//"output W occurs between input B and output X"
//Formula is not satisfied! An error path is
//[iD, oU, iF, oV, iF, oX, iC, oZ, iA, oV, iB, oU, iE, oX] ([iA, oU])*
//Problem16.c
//(G (! (iB & ! oX) | (! oX WU (oW & ! oX))));
#include <stdio.h> 
#include <assert.h>
...
int input, output;
	//@ ltl invariant positive: ([] (! (AP(input == 2) && ! AP(output == 24)) || (! AP(output == 24) WU (AP(output == 23) && ! AP(output == 24)))));
