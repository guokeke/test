//#Safe
//
//Formula: (false R (! (oW & ! iD) | (! oV WU iD)))
//"output V does never occur after output W until input D"
...
int input, output;
	//@ ltl invariant positive: ([] (! (AP(output == 23) && ! AP(input == 4)) || (! AP(output == 22) WU AP(input == 4))));
