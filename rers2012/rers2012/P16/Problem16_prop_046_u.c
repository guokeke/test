//#Unsafe
//
//Formula: (false R (! (iE & ! oY) | (! oY U (oX & ! oY))))
//"output X occurs after input E until output Y"
...
int input, output;
	//@ ltl invariant positive: ([] (! (AP(input == 5) && ! AP(output == 25)) || (! AP(output == 25) U (AP(output == 24) && ! AP(output == 25)))));
