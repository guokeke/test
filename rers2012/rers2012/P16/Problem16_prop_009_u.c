...
//[iA, oV, iF, oU, iC, oV, iE, oZ, iF, oZ, iB] ([oZ, iA, oY, iC, oV, iF, iB])*
//Problem16.c
...
int input, output;
	//@ ltl invariant positive: (! AP(output == 26) WU (AP(output == 26) WU (! AP(output == 26) WU (AP(output == 26) WU ([] ! AP(output == 26))))));
