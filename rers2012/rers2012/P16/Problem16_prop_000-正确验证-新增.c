//#Safe
//Formula: (false R (! (oW & ! iD) | (! iD U (oY & ! iD))))
//"output Y occurs after output W until input D"
...
int input, output;
	//@ ltl invariant positive: ([] (! (AP(output == 23) && ! AP(input == 4)) || (! AP(input == 4) U (AP(output == 25) && ! AP(input == 4)))));
