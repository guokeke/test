//#Safe
//
//Formula: (false R (! (iC & ! oV) | (! oW WU oV)))
//"output W does never occur after input C until output V"
...
int input, output;
	//@ ltl invariant positive: ([] (! (AP(input == 3) && ! AP(output == 22)) || (! AP(output == 23) WU AP(output == 22))));
